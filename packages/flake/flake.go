...
type Tool struct {
	...
	FromNixHub     bool     `json:"from_nixhub"`
	LazamarChannel string   `json:"lazamar_channel"`
}
...
func (c *Context) AddTool(r *search.PackageSearchResult) {
	c.Tools = append(c.Tools, Tool{
		...
		FromNixHub:     r.FromSearch.NixVersionsBackend.NixHub,
		LazamarChannel: r.FromSearch.NixVersionsBackend.LazamarChannel,
		Resolved: Resolved{
			Name:      r.Selected.Name,
			Version:   r.Selected.Version,
			Attribute: r.Selected.Attribute,
			Flake:     r.Selected.Flake,
			Revision:  r.Selected.Revision,
		},
	})
